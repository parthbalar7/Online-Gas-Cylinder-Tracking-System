...
function initAdmin() {
  ...
  var employees = [];
  var markup;
  axios__WEBPACK_IMPORTED_MODULE_0___default().get('/employee', {
    headers: {
  ...
  function renderItems(items) {
    ...
    return parsedItems.map(function (menuItem) {
      return "\n                <p>".concat(menuItem.item.name, " - ").concat(menuItem.qty, " pcs :-  ").concat(menuItem.item.price * menuItem.qty, " rs.</p>\n            ");
    }).join('');
  }

  function deliveryAss(employees, order) {
    var deliveryPerson = Object.values(employees);
    return deliveryPerson.map(function (person) {
      return "\n                \n                <option value=\"".concat(person.uid, "\"").concat(order.did === person.uid ? 'selected' : '', ">\n                ").concat(person.name, "</option>\n            \n            ");
    }).join('');
  }

  function generateMarkup(orders, employees) {
    return orders.map(function (order) {
      return "\n                <tr>\n                <td class=\"border px-4 py-2 text-green-900\">\n                    <div>".concat(renderItems(order.items), "</div>\n                </td>\n                <td class=\"border px-4 py-2\">").concat(order.customerId.name, " </br> ").concat(order.address, " </br> ").concat(order.area, "</td>\n                <td class=\"border px-4 py-2\">").concat(order.phone, "</td>\n                <td class=\"border px-4 py-2\">").concat(order.lpgId, "</td>\n                <td class=\"border px-4 py-2\">\n                    <div class=\"inline-block relative w-64\">\n                    <form action=\"/admin/delivery\" method=\"POST\">\n                            <input type=\"hidden\" name=\"orderId\" value=\"").concat(order._id, "\">\n                            <select name=\"did\" onchange=\"this.form.submit()\" selected=\"\"\n                                class=\"block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline\">\n                                <option>Select Delivery Person</option>\n                                ").concat(deliveryAss(employees, order), "\n                            </select>\n                    </form>\n                    <div\n                            class=\"pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700\">\n                            <svg class=\"fill-current h-4 w-4\" xmlns=\"http://www.w3.org/2000/svg\"\n                                viewBox=\"0 0 20 20\">\n                                <path\n                                    d=\"M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z\" />\n                            </svg>\n                    </div>\n                    </div>\n                </td>\n\n                <td class=\"border px-4 py-2\">\n                    ").concat(moment__WEBPACK_IMPORTED_MODULE_1___default()(order.createdAt).format('DD/MM/YYYY'), " </br>\n                    ").concat(moment__WEBPACK_IMPORTED_MODULE_1___default()(order.createdAt).format('hh:mm A'), "\n                </td>\n                <td class=\"border px-4 py-2\">\n                    ").concat(order.paymentStatus, "\n                </td>\n            </tr>\n        ");
    }).join('');
  }
}
...
/* harmony import */ var _delivery__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./delivery */ "./resources/js/delivery.js");
...
var removeEmployee = document.querySelectorAll('.remove-employee');
...
(0,_delivery__WEBPACK_IMPORTED_MODULE_4__.initDelivery)(); //change order status
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      stepCompleted = false;
      time.innerText = moment__WEBPACK_IMPORTED_MODULE_1___default()(order.updatedAt).format('DD/MM/YYYY hh:mm A');
...
socket.on('orderUpdated', function (data) {
  ...
  updateOrder.updatedAt = moment__WEBPACK_IMPORTED_MODULE_1___default()().format();
...
function deleteEmployee(employee) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('remove-employee', employee).then(function (res) {
    new (noty__WEBPACK_IMPORTED_MODULE_2___default())({
      type: 'success',
      timeout: 2000,
...
removeEmployee.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var employee = JSON.parse(btn.dataset.emp);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initDelivery": () => /* binding */ initDelivery
/* harmony export */ });
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
...
function initDelivery() {
  var deliveryTableBody = document.querySelector('#deliveryTableBody');
  var orders = [];
  var markup;
  axios__WEBPACK_IMPORTED_MODULE_0___default().get('/delivery/orders', {
    headers: {
      "X-Requested-With": "XMLHttpRequest"
    }
  }).then(function (res) {
    ...
    deliveryTableBody.innerHTML = markup;
  })["catch"](function (err) {
    console.log(err);
  });
  ...
  function generateMarkup(orders) {
    return orders.map(function (order) {
      return "\n                <tr>\n                <td class=\"border px-4 py-2 text-green-900\">\n                    <div>".concat(renderItems(order.items), "</div>\n                </td>\n                <td class=\"border px-4 py-2\">").concat(order.customerId.name, " </br> ").concat(order.address, " </br> ").concat(order.area, "</td>\n                <td class=\"border px-4 py-2\">").concat(order.phone, "</td>\n                <td class=\"border px-4 py-2\">").concat(order.lpgId, "</td>\n                <td class=\"border px-4 py-2\">\n                    <div class=\"inline-block relative w-64\">\n                        <form action=\"/delivery/order/status\" method=\"POST\">\n                            <input type=\"hidden\" name=\"orderId\" value=\"").concat(order._id, "\">\n                            <select name=\"status\" onchange=\"this.form.submit()\"\n                                class=\"block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline\">\n                                <option value=\"order_placed\"\n                                    ").concat(order.status === 'order_placed' ? 'selected' : '', ">\n                                    Placed</option>\n                                <option value=\"confirmed\" ").concat(order.status === 'confirmed' ? 'selected' : '', ">\n                                    Confirmed</option>\n                                <option value=\"dispatched\" ").concat(order.status === 'dispatched' ? 'selected' : '', ">\n                                    Dispatched</option>\n                                <option value=\"out_for_delivery\" ").concat(order.status === 'out_for_delivery' ? 'selected' : '', ">\n                                    Out for Delivery\n                                </option>\n                                <option value=\"completed\" ").concat(order.status === 'completed' ? 'selected' : '', ">\n                                    Completed\n                                </option>\n                            </select>\n                        </form>\n                        <div\n                            class=\"pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700\">\n                            <svg class=\"fill-current h-4 w-4\" xmlns=\"http://www.w3.org/2000/svg\"\n                                viewBox=\"0 0 20 20\">\n                                <path\n                                    d=\"M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z\" />\n                            </svg>\n                        </div>\n                    </div>\n                </td>\n                <td class=\"border px-4 py-2\">\n                ").concat(moment__WEBPACK_IMPORTED_MODULE_1___default()(order.createdAt).format('DD/MM/YYYY'), " </br>\n                ").concat(moment__WEBPACK_IMPORTED_MODULE_1___default()(order.createdAt).format('hh:mm A'), "\n                </td>\n                <td class=\"border px-4 py-2\">\n                    ").concat(order.paymentStatus, "\n                </td>\n            </tr>\n        ");
    }).join('');
  }
}
